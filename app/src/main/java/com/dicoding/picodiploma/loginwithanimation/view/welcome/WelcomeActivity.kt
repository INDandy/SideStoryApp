...
class WelcomeActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val login = ObjectAnimator.ofFloat(binding.loginHomeButton, View.ALPHA, 1f).setDuration(100)
        val signup = ObjectAnimator.ofFloat(binding.signupHomeButton, View.ALPHA, 1f).setDuration(100)
